    ...
    <div style={page}>
      ...
      <div style={panel}>
        ...
        <div style={row}>
          ...
          <input type="number" step="0.1" min="1" max={garment.print.wIn} value={widthIn}
